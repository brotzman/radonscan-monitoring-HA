(() => {
  ...
  function deletePayload(preview=false) {return {action:$('deleteAction').value,preview,start:toIso($('deleteStart').value),end:toIso($('deleteEnd').value),device_id:$('deleteDevice').value||null,location_id:$('deleteLocation').value||null,campaign_id:$('deleteCampaign').value||null,confirmation:preview?'': 'DELETE',confirmed:!preview};}
