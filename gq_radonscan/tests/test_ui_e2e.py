...
def _state(language="de"):
    return {
        ...
        "mqtt":{"connected":True},"homeassistant":{"connected":True,"location_name":"Home","version":"2026.7","time_zone":"Europe/Berlin"},
...
def test_all_views_have_no_horizontal_overflow(width,height):
    with sync_playwright() as p:
        ...
        for view in ['overview','analysis','expert','map','history','reports','data','system','settings','help']:
